...
#■サブ<<USB-CDC>>
#COM_PORT = 'COM45' 
  # 全部＋メイン(全部)                 : 3.115 ms (100%)
  # 全部＋メイン(UART)                 : 1.993 ms ( 64%)
#-------------------------------------------------------------------------------------------------
#■ブリッジ<<ESP-NOW>>
#COM_PORT = 'COM47'
  # ESP-NOW＋メイン(全部          )    : 6.293 ms (100%)
  # ESP-NOW＋メイン(ターボ+ESP-NOW)    : 5.328 ms ( 85%)
  #-----------------------------------------------------------------------------------------------
  # ESP-NOW＋サブ(全部)＋メイン(全部)  : 7.780 ms (100%)
  # ESP-NOW＋サブ(全部)＋メイン(UART)  : 6.238 ms ( 80%)
#-------------------------------------------------------------------------------------------------
...
#COM_TRANS = "BRIDGE/ESPN:90DA72741AF0!" # COM45 :
