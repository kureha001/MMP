...
//========================================================
  ...
  //─────────────────
  //・所有者：スケッチ
  //・利用者：通信アダプタ、パーサ内部の特定機能
  //・利用法：公開ポインタ経由でアクセス
  //・用途等：所有権を保持したまま依存方向を制御
  //─────────────────
  // 定義元：parser.h
  //━━━━━━━━━━━━━━━━━
  Parser parser(ctx)          ; // 本体(依存性注入)
  Parser* INO_PARSER = &parser; // 外部公開ポインタ
...
// - INO_PARSER->Init()：利用できる機能はこの関数以降で定義
//========================================================
void setup(){
  //┬
  //○通信デバイスを初期化
