...
#=================================================================================================
#□メイン ※GPIO:921600bps
#COM_PORT = 'COM50'    #USB CDC⇔□全部       = 1.809 ms (100%)  ◎
                       #   GPIO⇔□ 〃        = 2.338 ms (129%)  ○
#COM_PORT = 'COM148'   #USB CDC⇔□UART(標準) = 1.082 ms ( 60%)  ◎
                       #   GPIO⇔□ 〃　　    = ？？？              ※ブリッジ：不可
#COM_PORT = 'COM48'    #USB CDC⇔□UART(高速) = 0.434 ms ( 28%)  ★ ※ブリッジ・サブ連携：不可
#           'COM49'    #　　 ○⇔□ESP-NOW    = ※UART：不可(ブリッジを参照)　　
#=================================================================================================
#◇サブ
#COM_PORT = 'COM59'
  #<<GPIO:3Mbps>>　 USB⇔◇COM59:全部━GPIO┳□COM50 :全部 = 3.131 ms (100%)　○
  #　　　　　　　　　　　　　　　　　　　　┗□COM148:標準 = 1.993 ms ( 70%)　◎
  #-------------------------------------------------------------------------------------
  #　　　　　　　　　○⇔◇COM45:ESPN━GPIO┳□COM50 :全部 = ※UART：不可(ブリッジを参照)
  #　　　　　　　　　　　　　　　　　　　　┗□COM148:標準 = ※UART：不可(ブリッジを参照)
#=================================================================================================
#○ブリッジ
COM_PORT = 'COM61'
  #<<全部／USB>>　　　　　　　　　　　　　 ┏□COM50 :全部 = 6.560 ms (100%) ×
  #　　　　　　　　　┏━━━━━━━━━━┻□COM49 :ESPN = 6.342 ms ( 96%) ×
  # USB⇔○全部━ESPN┫┏◇COM59:全部━GPIO┳□COM50 :全部 = 8.812 ms (134%) ×
  #　　　　(COM61)　 ┗┫　　　　　　　　　┗□COM148:標準 = 8.297 ms (126%) ×
  #　　　　　　　　　　┗◇COM45:ESPN━GPIO┳□COM50 :全部 = 8.157 ms (124%) ×
  #                                        ┗□COM148:標準 = 7.633 ms (116%) ×
  #
  #<<全部／GPIO:926200bps>>　　　　　　 　 ┏□COM50 :全部 = ？？？
  #　　　　　　　　　┏━━━━━━━━━━┻□COM49 :ESPN = ？？？
  #GPIO⇔○全部━ESPN┫┏◇COM59:全部━GPIO┳□COM50 :全部 = ？？？
  #　　　　(CH:A)　　┗┫ 　         　　　┗□COM148:標準 = ？？？
  #　　　　　　　　　　┗◇COM45:ESPN━GPIO┳□COM50 :全部 = ？？？
  #　　　　　　　　　　　　　　　　　　　　┗□COM148:標準 = ？？？
  #-------------------------------------------------------------------------------------
#COM_PORT = 'COM47'
  #<<EPSN+UART(標準)／USB>>　　　　　　　　┏□COM50 :全部 = 6.293 ms (100%) ×
  #　　　　　　　　　┏━━━━━━━━━━┻□COM49 :ESPN = 5.410 ms ( 86%) △
  # USB⇔○標準━ESPN┫┏◇COM59:全部━GPIO┳□COM50 :全部 = 7.780 ms (100%) ×
  #　　　　(COM47)　 ┗┫　　　　　　　　　┗□COM148:標準 = 6.238 ms ( 80%) ×
  #　　　　　　　　　　┗◇COM45:ESPN━GPIO┳□COM50 :全部 = 5.750 ms ( 74%) △
  #                                        ┗□COM148:標準 = 5.512 ms ( 71%) △
  #
  #<<EPSN+UART(標準)／GPIO:926200bps>>　 　┏□COM50 :全部 = ？？？
  #　　　　　　　　　┏━━━━━━━━━━┻□COM49 :ESPN = ？？？
  #GPIO⇔○標準━ESPN┫┏◇COM59:全部━GPIO┳□COM50 :全部 = ？？？
  #　　　　(CH:A)　　┗┫ 　         　　　┗□COM148:標準 = ？？？
  #　　　　　　　　　　┗◇COM45:ESPN━GPIO┳□COM50 :全部 = ？？？
  #　　　　　　　　　　　　　　　　　　　　┗□COM148:標準 = ？？？
  #-------------------------------------------------------------------------------------
#COM_PORT = 'COM60'
  #<<EPSN+UART(高速)／USB>>　　　　　　　　┏□COM50 :全部 = 6.090 ms (100%) ×
  #　　　　　　　　　┏━━━━━━━━━━┻□COM49 :ESPN = 5.305 ms ( 87%) △
  # USB⇔○高速━ESPN┫┏◇COM59:全部━GPIO┳□COM50 :全部 = 7.559 ms (124%) ×
  #　　　　(COM60)　 ┗┫ 　         　　　┗□COM148:標準 = 7.538 ms (124%) × 
  #　　　　　　　　　　┗◇COM45:ESPN━GPIO┳□COM50 :全部 = 7.308 ms (120%) ×
  #　　　　　　　　　　　　　　　　　　　　┗□COM148:標準 = 6.647 ms (109%) ×
#-------------------------------------------------------------------------------------------------
COM_TRANS = ""
#【ESP NOW】
#□メイン
...
#COM_TRANS = "BRIDGE/ESPN:90DA72741AF0!" # COM45:ESP-NOWのみ
#-------------------------------------------------------------------------------------------------
#【TCP】
#COM_TRANS = "BRIDGE/TCP:192.168.2.99:8081!"   #□メイン
#COM_TRANS = "BRIDGE/TCP:192.168.2.147:8081!"  #◇サブ
#【WEB Socket】
#COM_TRANS = "BRIDGE/WSOC:192.168.2.99:8082!"  #□メイン
#COM_TRANS = "BRIDGE/WSOC:192.168.2.147:8082!" #◇サブ
#【BLE】
#COM_TRANS = "BRIDGE/BLE:MMP-ESP32S3!"         #□メイン
#COM_TRANS = "BRIDGE/BLE:MMP-SUB-001!"         #◇サブ
#=================================================================================================
