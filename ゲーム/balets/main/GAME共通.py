...
#┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
import  pyxel
from    main.汎用部品           import mmp,入力操作
...
class BGM_DFP():
    ...
    # プレイ画面(ザコ)のMP3ファイル再生時間
    ザコ = { 1:56,  2:60,  3:105,  4:90,  5:87,  6:60,  7:77,   8:63,            
             9:62, 10:59, 11:65,  12:53, 13:87, 14:50, 15:115, 16:49 }

    # プレイ画面(ボス)のMP3ファイル再生時間
    ボス = { 1:70,  2:85,   3:116,  4:136,  5:84,   6:84,  7:61,   8:67,            
             9:57, 10:111, 11:89,  12:164, 13:122, 14:98, 15:133, 16:135 }
	#────────────────────────────────────
    def 自動選択():
        シーン  = DS.情報.シーン
	...
	#────────────────────────────────────
    def 指定曲ザコ():
        トラック = min(16,DS.情報.難易度)
        DS.情報.再生時間 = BGM_DFP.ザコ[トラック]
        入出力.MMP.DFP_PlayFolderTrack(1,2,min(16,トラック))
	#────────────────────────────────────
    def 指定曲ボス():
        トラック = min(16,DS.情報.難易度-1)
        DS.情報.再生時間 = BGM_DFP.ボス[トラック]
        入出力.MMP.DFP_PlayFolderTrack(1,3,min(16,トラック))
